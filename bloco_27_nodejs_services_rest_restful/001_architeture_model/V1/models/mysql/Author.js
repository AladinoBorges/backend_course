...
async function getAll() {
  ...
  const serializedData = authors.map(serializeSnakeToCamelCase);
  const insertedAuthorsFullname = serializedData.map(fullnameCreator);

  return insertedAuthorsFullname;
}
